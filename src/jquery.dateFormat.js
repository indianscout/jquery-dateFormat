/*
 * Simplified version of phstc/jquery-dateFormat.js
 * Same usage like phstc/jquery-dateFormat:
...
$.format = {
	...
	shortMonthsInYea:	['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
	longMonthsInYear:	['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
	shortMonthsToNumber: 	{ 'Jan': '01', 'Feb': '02', 'Mar': '03', 'Apr': '04', 'May': '05', 'Jun': '06', 'Jul': '07', 'Aug': '08', 'Sep': '09', 'Oct': '10', 'Nov': '11', 'Dec': '12' },
        ...
        if(typeof value == 'number') {
          ...
          switch (values.length) {
            case 6:
              ...
              parsedDate.month      = this.shortMonthToNumber(values[1]);
              parsedDate.dayOfMonth = values[2];
	...
	date: function(value, format){
        try{
          ...
          for(var i = 0; i < format.length; i++) {
            ...
            switch (pattern) {
              case 'ddd':
                retValue += this.numberToLongDay(dayOfWeek);
                pattern = '';
                break;
              case 'dd':
                if(nextRight === 'd') {
              ...
              case 'D':
                ...
                break;
              case 'MMMM':
                retValue += this.numberToLongMonth(month);
                pattern = '';
                break;
              case 'MMM':
                if(nextRight === 'M') {
                ...
                retValue += this.numberToShortMonth(month);
                pattern = '';
                break;
              case 'MM':
                if(nextRight === 'M') {
              ...
              case 'SS':
                ...
                break;
              case 'SSS':
                retValue += this.padding(time.millis.substring(0, 3), 3);
                pattern = '';
                break;
              case 'a':
              ...
              case 'p':
                ...
                break;
              case 'E':
                retValue += this.numberToShortDay(dayOfWeek);
                pattern = '';
                break;
              case "'":
                pattern = '';
